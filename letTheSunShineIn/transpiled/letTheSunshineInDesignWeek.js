...
// GLOBALS
// ------------------------------------------------
let WHEEL_SENSITIVITY = 0.0008;
let GRAVITY = 0.0002;
let SCREEN_HEIGHT = window.innerHeight / 40;
let SUN_RADIUS = 7.5;
let WHEEL_START_POSITION = 0.2;
// ------------------------------------------------
// FUN STARTS HERE
// ------------------------------------------------
let main = function () {
...
class Model {
    ...
    update(wheel, clock) {
        ...
        this.sun.position.y = Math.pow(Math.sin(5 * x / Math.PI), 3) * toScreenFactor - SCREEN_HEIGHT - SUN_RADIUS + 0.24;
...
class Controller {
    constructor(view, model) {
        ...
        window.addEventListener("wheel", () => {
            ...
            this.tutorial = false;
            this.wheel = Math.max(this.wheel, 0.2);
        }, true);
    }
    update() {
        if (this.tutorial) {
            ...
            this.wheel = Math.sin(this.tutorialCounter * 0.003) * 0.48 + 0.05;
        }
        else {
            this.wheel -= GRAVITY;
        }
...
//# sourceMappingURL=letTheSunshineInDesignWeek.js.map